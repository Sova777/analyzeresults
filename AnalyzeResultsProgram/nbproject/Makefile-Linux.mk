...
LDLIBSOPTIONS=../AnalyzeFootballResults/dist/Linux/MinGW-Windows/libAnalyzeFootballResults.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/analyzeresultsprogram.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/analyzeresultsprogram.exe: ../AnalyzeFootballResults/dist/Linux/MinGW-Windows/libAnalyzeFootballResults.so
