...
${TESTDIR}/tests/report1.o: tests/report1.cpp 
	...
	$(COMPILE.cc) -g -I. -I. -I. -I. -I. -I. -o ${TESTDIR}/tests/report1.o tests/report1.cpp


${TESTDIR}/tests/report2.o: tests/report2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	$(COMPILE.cc) -g -I. -I. -I. -I. -o ${TESTDIR}/tests/report2.o tests/report2.cpp


${TESTDIR}/tests/report3.o: tests/report3.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	$(COMPILE.cc) -g -I. -I. -I. -I. -o ${TESTDIR}/tests/report3.o tests/report3.cpp
