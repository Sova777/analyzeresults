...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk dist/Windows/MinGW-Windows/QAnalyzeFootballResults.exe

build/Windows/%.o: nbproject/qt-Windows.mk
	$(MAKE) -f nbproject/qt-Windows.mk "$@"

# Subprojects
.build-subprojects:

# Clean Targets
.clean-conf: ${CLEAN_SUBPROJECTS} nbproject/qt-Windows.mk
	$(MAKE) -f nbproject/qt-Windows.mk distclean
